...
/**
 * dubbo protocol support. TODO 在HeaderExchangeHandler 或许处理到实际提供者方法
 */
public class DubboProtocol extends AbstractProtocol {
    ...
    /**
     * Dubbo 写服务暴露实现细节
     * 1. 创建DubboProtocol 实例，并创建export
     *
    ...
    /**
     * ExchangeClient 并不具有通信能力，具体的实现是NettyClient, MinaClient
     * @param url
     * @return
     */
    ...
    /**
     * Get shared connection TODO 获取共享客户端
     */
    private ExchangeClient getSharedClient(URL url) {
        ...
        synchronized (locks.get(key)) {
            ...
            // TODO 将 ExchangeClient 实例传给 ReferenceCountExchangeClient，这里使用了装饰模式
